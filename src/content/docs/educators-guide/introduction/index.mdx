...
description: A guide for educators implementing the FTCSoftware.org Learning Course
---

The FTCSoftware.org Learning Course is a self-paced, comprehensive program that teaches FTC robot programming and Java skills.
...
It utilizes code and robot simulation, a tool standard throughout FTC programming, to enable students to see their work and results quickly and not require a specific robot, or any robot access.
...
While the initial Java content is taught via general exercises, the majority of the course is focused on teaching FTC programming skills through FTC-relevant exercises, where new skills and concepts are introduced in each project.
...
These cover topics that are relevant to FTC programming, such as swerve or vision, but aren't necessarily the core concepts that need to be taught to allow a student to meaningfully contribute in-season.
...
The purpose of software in FTC is to maximize the robot's capabilities in matches, working hand in hand with the robot's design and the team's strategy.
