---
title: The Stages
description: An explanation FTCSoftware.org Learning Course stages for educators
---
...
- Teaches students the Java concepts necessary for FTC software

**Stage 1a: Basic FTC Programming**

- Introduces students to many of the development tools which will be used throughout the course and for general FTC development
- Provides an overview of FTC electronics
- Introduces students to the 2026 Kitbot, which will be utilized throughout Stage 1
- Teaches the basics of FTC motor controller and gamepad interaction
