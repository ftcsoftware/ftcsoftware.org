...
Congratulations!
Whether you already know Java, have programmed an FTC robot before,
...
This stage covers how to fully program a working kitbot for the 2026 FIRST Tech Challenge game,
REBUILT.
